...
import { FaChartLine, FaClock, FaEdit, FaEnvelope, FaMapMarkerAlt, FaPhone, FaPlug, FaStar } from "react-icons/fa";
          ...
          {stations.map((station) => {
            ...
            return (
              <article className="entity-card station-card" key={station.id}>
                ...
                <div className="card-actions" style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                  <button
                  ...
                  <button
                    className="secondary-button"
                    onClick={() => navigate(`/operator/demand-forecast?station=${station.id}`)}
                    type="button"
                  >
                    <FaChartLine style={{ color: "var(--primary)" }} /> Forecast
                  </button>
                  <button
