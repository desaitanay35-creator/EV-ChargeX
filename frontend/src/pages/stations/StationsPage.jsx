                    ...
                    <div className="entity-card-top">
                      <div className="card-top-left-badges">
                        ...
                        {station.predicted_wait_time > 0 && (
                          <span className="station-routed-badge" style={{ background: "rgba(239, 68, 68, 0.15)", color: "#ef4444", border: "1px solid rgba(239, 68, 68, 0.3)" }}>
                            <FaClock /> Queue Wait: {station.predicted_wait_time} mins
                          </span>
                        )}
                      </div>
