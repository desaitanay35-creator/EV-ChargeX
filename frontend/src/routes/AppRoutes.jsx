...
import OperatorDemandForecastPage from "../pages/operator/OperatorDemandForecastPage";
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<ErrorBoundary><MainLayout /></ErrorBoundary>}>
          ...
          <Route element={<ProtectedRoute allowedRoles={["OPERATOR", "ADMIN"]} />}>
            ...
            <Route path="/operator/demand-forecast" element={<OperatorDemandForecastPage />} />
